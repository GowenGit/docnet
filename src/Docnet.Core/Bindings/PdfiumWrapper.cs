...
namespace Docnet.Core.Bindings
{
    ...
    public unsafe partial class FS_MATRIX_ : IDisposable
    {
        ...
        public partial struct __Internal
        {
            ...
            [DllImport("Lib/pdfium", CallingConvention = CallingConvention.Cdecl,
    ...
    public unsafe partial class FPDF_FILEWRITE_ : IDisposable
    {
        ...
        public partial struct __Internal
        {
            ...
            [FieldOffset(8)] internal IntPtr WriteBlock;
        ...
        internal static readonly
            ConcurrentDictionary<IntPtr,
                FPDF_FILEWRITE_> NativeToManagedMap =
                new ConcurrentDictionary<IntPtr,
                    FPDF_FILEWRITE_>();
        ...
        internal static FPDF_FILEWRITE_ __CreateInstance(IntPtr native,
            bool skipVTables = false)
        {
            return new FPDF_FILEWRITE_(native.ToPointer(), skipVTables);
        }

        internal static FPDF_FILEWRITE_ __CreateInstance(
            __Internal native, bool skipVTables = false)
        {
        ...
        private FPDF_FILEWRITE_(__Internal native,
            bool skipVTables = false)
            : this(__CopyValue(native), skipVTables)
        {
            __ownsNativeInstance = true;
        ...
        public FPDF_FILEWRITE_(FPDF_FILEWRITE_ _0)
        {
            __Instance = Marshal.AllocHGlobal(sizeof(__Internal));
            __ownsNativeInstance = true;
            NativeToManagedMap[__Instance] = this;
    ...
    public unsafe partial class fpdf_save
    {
        public partial struct __Internal
        {
            ...
            internal static extern int FPDF_SaveAsCopy(IntPtr document, IntPtr pFileWrite,
                uint flags);

            [SuppressUnmanagedCodeSecurity]
            [DllImport("Lib/pdfium", CallingConvention = CallingConvention.Cdecl,
                EntryPoint = "FPDF_SaveWithVersion")]
            internal static extern int FPDF_SaveWithVersion(IntPtr document,
                IntPtr pFileWrite, uint flags, int fileVersion);
        }

        public static int FPDF_SaveAsCopy(FpdfDocumentT document,
            FPDF_FILEWRITE_ pFileWrite, uint flags)
        {
            var __arg0 = ReferenceEquals(document, null) ? IntPtr.Zero : document.__Instance;
            var __arg1 = ReferenceEquals(pFileWrite, null) ? IntPtr.Zero : pFileWrite.__Instance;
            var __ret = __Internal.FPDF_SaveAsCopy(__arg0, __arg1, flags);
            return __ret;
        }

        public static int FPDF_SaveWithVersion(FpdfDocumentT document,
            FPDF_FILEWRITE_ pFileWrite, uint flags, int fileVersion)
        {
            var __arg0 = ReferenceEquals(document, null) ? IntPtr.Zero : document.__Instance;
            var __arg1 = ReferenceEquals(pFileWrite, null) ? IntPtr.Zero : pFileWrite.__Instance;
